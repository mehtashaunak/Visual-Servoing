...
#defining the Range of Blue color
	blue_lower = np.array ([100, 1, 1], np.uint8)
	blue_upper = np.array ([120, 255, 255], np.uint8)
#defining the Range of yellow color
	yellow_lower = np.array ([25, 1, 1], np.uint8)
	yellow_upper = np.array ([45, 255, 255], np.uint8)
#defining the range of green color
	green_lower = np.array ([50, 1, 1], np.uint8)
...
# Opening morph(erosion followed by dilation)
	...
	z1 = (depth_img[r1][c1]+1)/1000.000
	z2 = (depth_img[r2][c2]+1)/1000.000
	z3 = (depth_img[r3][c3]+1)/1000.000
	z4 = (depth_img[r4][c4]+1)/1000.000
	...
	# Vcamera = [0.0,0.0,0.0,0.0,0.08,0.0]
	Vcam11 = Vcamera
	Vcamera = -Vcam11
...
def main():
	...
	sub1 = rospy.Subscriber('camera/depth/image_raw', Image, depth_callback, queue_size=1)
