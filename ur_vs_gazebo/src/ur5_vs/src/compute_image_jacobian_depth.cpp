...
//        L.at<double>(i+1,5) = -u[i];
    ...
    L.at<double>(i+1,0) = 0.0;
    L.at<double>(i+1,1) = -1.0;
    L.at<double>(i+1,2) = 0.0;
    L.at<double>(i+1,3) = -u[i];
    L.at<double>(i+1,4) = 0;
    L.at<double>(i+1,5) = z[0];


    L.at<double>(i+2,0) = 0.0;
    L.at<double>(i+2,1) = 0.0;
    L.at<double>(i+2,2) = -1;
    L.at<double>(i+2,3) = 0.0;
    L.at<double>(i+2,4) = u[i];
    L.at<double>(i+2,5) = -u[i+1];
