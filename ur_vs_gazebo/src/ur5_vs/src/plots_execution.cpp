...
int main(int argc, char** argv)
{
    ...
    G1.gnuplot_cmd("set output '/home/mithun/exp0/joint_velocities.eps'");
    ...
    G12.gnuplot_cmd("set terminal postscript eps enhanced color solid lw 1.5 font 'Arial,22'");
    G12.gnuplot_cmd("set output '/home/mithun/exp0/joint_angles.eps'");
    ...
    G2.gnuplot_cmd("set terminal postscript eps enhanced color solid lw 1.5 font 'Arial-Bold,22'");
    G2.gnuplot_cmd("set output '/home/mithun/exp0/camera_velocities.eps'");
    ...
    G31.gnuplot_cmd("set output '/home/mithun/exp0/feature_error_x.eps'");
    ...
    G32.gnuplot_cmd("set output '/home/mithun/exp0/feature_error_y.eps'");
    ...
    G33.gnuplot_cmd("set output '/home/mithun/exp0/feature_error_area.eps'");
    ...
    G34.gnuplot_cmd("set output '/home/mithun/exp0/feature_error_norm.eps'");
    ...
    G35.gnuplot_cmd("set terminal postscript eps enhanced color solid lw 1.5 font 'Arial,22'");
    G35.gnuplot_cmd("set output '/home/mithun/exp0/feature_error_all.eps'");
    ...
    G4.gnuplot_cmd("set output '/home/mithun/exp0/trajcompare.eps'");
