...
double x_point, y_point, point_1_x, point_1_y, point_2_x, point_2_y, point_3_x, point_3_y, point_4_x, point_4_y;
...
void img_proc_callback(const new_detection::points_four_image_data msg)
{
    ...
    points_corner[0]= msg.detected_point_0.data;
    points_corner[1] = msg.detected_point_1.data;
    points_corner[2] = msg.detected_point_2.data;
    points_corner[3] = msg.detected_point_3.data;
    points_corner[4] = msg.detected_point_4.data;
    points_corner[5] = msg.detected_point_5.data;
    points_corner[6] = msg.detected_point_6.data;
    points_corner[7] = msg.detected_point_7.data;
    area_points = msg.area.data;
...
int main (int argc, char** argv)
{
    ...
    cv::Mat Jg_geo = cv::Mat(NW, NL, CV_64F, 0.0);
...
Error_p.at<double>(2,0) = area_points-7754550;
    ...
    while(ros::ok())
    {
        ...
        compute_image_jacobian_area(points_corner, depth_p, L);


//        (double u[], m, double &a, depth_p, L)
...
//        robot.get_joint_angles(theta);

//        cout<< "th0 = " <<" "<< (theta[0])*180/3.14<<" "<< (theta[1])*180/3.14<<" "<< (theta[2])*180/3.14<<" "<< (theta[3])*180/3.14<<" "<< (theta[4])*180/3.14<<" "<< (theta[5])*180/3.14<<endl;


//        robot.compute_geometric_jacobian(Jg_geo);

//        cout<<"get_geo_jacobian"<<Jg_geo<<endl;
//        cout<<"moveit_jacobian"<<Jg<<endl;
...
//        VV.at<double>(0,0)=0.0;
//        VV.at<double>(1,0)=0.001;
//        VV.at<double>(2,0)=0.0;
//        VV.at<double>(3,0)=0.0;
//        VV.at<double>(4,0)=0.0;
//        VV.at<double>(5,0)=0.0;
